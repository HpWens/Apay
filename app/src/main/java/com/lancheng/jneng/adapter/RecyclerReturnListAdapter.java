 ...
 */
public class RecyclerReturnListAdapter extends RecyclerView.Adapter<RecyclerReturnListAdapter.ViewHolder> {
    ...
    public RecyclerReturnListAdapter(Context mContext,
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            title = (TextView) itemView.findViewById(R.id.item_returnlist_name);
            address = (TextView) itemView.findViewById(R.id.item_returnlist_address);
            icon = (RoundImageView) itemView.findViewById(R.id.item_returnlist_icon);
            view = (LinearLayout) itemView.findViewById(R.id.item_returnlist_view);
        }
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_returnlist, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (!TextUtils.isEmpty(mDatas.get(position).getName())) {
            holder.title.setHint(mDatas.get(position).getName());
        }
        if (!TextUtils.isEmpty(mDatas.get(position).getAddress())) {
            holder.address.setHint(mDatas.get(position).getAddress());
        }
