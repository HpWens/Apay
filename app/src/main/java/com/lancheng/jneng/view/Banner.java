...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_width, 15);
        mIndicatorHeight = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_height, 15);
    ...
    private boolean setImageArray(Object[] imagesUrl, OnLoadImageListener imageListener) {
        ...
        for (int i = 0; i <= count + 1; i++) {
            ...
            if (imageListener != null) {
                ...
                Glide.with(context)
                        .load(url)
                        .placeholder(R.drawable.pic_banner_special) //设置占位图
                        .error(R.drawable.pic_banner_special) //设置错误图片
...
//        }
    ...
    private void ctrlSwipRefreshLayout(boolean enable) {
        if (swipeRefreshLayout != null) {
    ...
    public void onPageScrollStateChanged(int state) {
        ctrlSwipRefreshLayout(state == ViewPager.SCROLL_STATE_IDLE);
        switch (state) {
            case 1:
                isAutoPlay = false;
                break;
