...
import com.lancheng.jneng.utils.SizeUtils;
...
/**
 * Created by AFLF on 2016/8/18. http://blog.csdn.net/qq_26971803/article/details/51537129
 */
public class ADTextView extends View {
    ...
    private List<InvestmentTypeInfo> mTexts; //显示文字的数据源
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        mFrontTextSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_front_size, SizeUtils.sp2px(getContext(), 15));
        mContentTextSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_content_size, SizeUtils.sp2px(getContext(), 15));
    ...
    //设置数据源
    public void setmTexts(List<InvestmentTypeInfo> mTexts) {
        this.mTexts = mTexts;
        postInvalidate();
    }
    ...
    //设置前置文字的大小
    public void setmFrontTextSize(int mFrontTextSize) {
        mPaintFront.setTextSize(mFrontTextSize);
    }

    //设置正文的文字大小
    public void setmContentTextSize(int mContentTextSize) {
    ...
    protected void onDraw(Canvas canvas) {
        if (mTexts != null) {
            InvestmentTypeInfo model = mTexts.get(mIndex);
            String font = "最新发布【担】";
            String back = model.getName();
            //绘制前缀
